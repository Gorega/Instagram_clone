...
export default function Comment({comment,post}){
    ...
    return <>
        ...
        <div className={styles.more}>
            <ul>
                ...
                <li onClick={()=> {
                     ...
                     dispatch(setCustomPostOptions({type:"commentList",content:<PostOptionsModal commentCreatorId={comment.createdBy} post_id={post._id} comment_id={comment._id} />}))
                }}>...</li>
            </ul>
        </div>
        ...
        }} className={activeLike && styles.active}><FontAwesomeIcon icon={faHeart} /></span>
        </div>
    </>
}