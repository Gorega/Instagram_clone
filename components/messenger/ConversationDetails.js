...
import { setPending, setShowConversationChat } from "../../features/messengerSlice";
import { server } from "../../lib/server";
import styles from "../../styles/components/messenger/ConversationDetails.module.css";

export default function ConversationDetails({conversation,member,closeConversationDetails}){
    ...
    return <>
        ...
        <div className={styles.head}>
            <h2>Details</h2>
            <div className={styles.info} onClick={closeConversationDetails}>
